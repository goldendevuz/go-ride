...
class UserConfirmation(BaseModel):
    ...
    verify_type = models.CharField(max_length=31, choices=AuthType, default=AuthType.VIA_PHONE)
    ...
    def save(self, *args, **kwargs):
        # Auto-set expiration before validation
        ...
        self.full_clean()  # runs field validators
